...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:24px">
  ...
  <div class="card">
    ...
    <div class="chart-bar-group">
      ...
      <?php $cc = $catColors[$cat['category']] ?? ['rgba(200,200,200,0.5)', '#fff']; ?>
      <div class="chart-row">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:16px">
      ...
      <div style="padding:5px 12px;background:var(--surface2);border-radius:20px;font-size:0.75rem">
        ...
        <strong style="margin-left:4px"><?= round($cat['total'] / max($totalMonth, 1) * 100) ?>%</strong>
      </div>
      <?php endforeach; ?>
    </div>
  </div>
  ...
  <div class="card">
    ...
    <div class="chart-bar-group">
      ...
      foreach ($monthlyEvolution as $me):
      ?>
      <div class="chart-row">
